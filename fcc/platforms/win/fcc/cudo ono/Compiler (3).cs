...
namespace fcc
{
    class Compiler
    {
        ...
        #region Variables
            ...
            private static readonly List<string> _embeddedFunctionList = new List<string>();
            ...
            #region Parsing Functions
                ...
                #region Convert To Registers
                    ...
                    #region Convert To Registers Functions
                        ...
                        private bool Exists(IEnumerable<Register> list, string s)
                        {
                        ...
                        private List<Command> AddLoad(List<Command> lines, Register reg, IEnumerable<Variable> list)
                        {
                        ...
                        private List<Command> AddSave(List<Command> lines, Register reg, IEnumerable<Variable> list)
                        {
                        ...
                        private void FillWithRegList(List<Command> lines, List<Register> regList, List<Variable> list)
                        {
                            ...
                            for (int i = 0; i < regList.Count; i++)
                            {
                                ...
                                c.Arguments[_currArg] = "R" + regList[i].RegName;
                ...
                #region Const and Temp
                    ...
                    #region Const
                        ...
                        private string ConstExists(IEnumerable<Variable> list, string value)
                        {
                            foreach (Variable c in list)
                            {
        ...
        #region Add Global Variable Values
            ...
            private void AddGlobalVarsAndConsts(IEnumerable<Variable> list, List<Command> line)
            {
        ...
        #region Additional Functions
            ...
            private Variable VariableNameExists(string name, IEnumerable<Variable> list)
            {
            ...
            private Variable FindVariable(IEnumerable<Variable> list, string name)
            {
                bool found = false;
            ...
            private Function FindFunciton(IEnumerable<Function> list, string name)
            {
                bool found = false;
                Function val = null;
            ...
            private Variable FindString(IEnumerable<Variable> list, string name)
            {
                bool found = false;
                Variable val = null;
