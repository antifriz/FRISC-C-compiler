...
namespace fcc
{
    class Compiler
    {
        ...
        #region Print
            ...
            private void Print(IEnumerable<Command> list)
            {
                Console.WriteLine();
            ...
            private void Print(IEnumerable<Function> list)
            {
                Console.WriteLine();
            ...
            private void Print(IEnumerable<Variable> list)
            {
                Console.WriteLine();
            ...
            private void Print(IEnumerable<Register> list)
            {
                if (list == null)
                    return;
            ...
            private string ConvertToString(IEnumerable<Command> list)
            {
                string output = "";
                foreach (Command c in list)
                {
        ...
        private IEnumerable<Command> Parse()
        {
            ParseFunctionPrototypes();
        ...
        #region Parse Functions
            ...
            #region Parsing Functions
                ...
                private IEnumerable<Command> ParseFunction(Function f)
                {
                ...
                #region Parsing Commands
                    ...
                    #region Parsing Commands Functions
                        ...
                        private static void ParseCommandReturn(Variable var, List<Command> line)
                        {
                            var c = new Command();
                            //c = SetLabel(c);
                            if (var != null)
                        ...
                        private static void ParseCommandLabel(string buffer, List<Command> line)
                        {
                            _started = true;
                            var c = new Command();
                            c.Label = buffer.Trim(':', '<', '>');
                ...
                #region Convert To Registers
                    ...
                    #region Convert To Registers Functions
                        ...
                        private static Command FindNextVar(List<Command> lines)
                        {
                        ...
                        private static List<Register> FillRegList(List<Command> lines)
                        {
                            _currLine = 0;
                            _currArg = -1;
                        ...
                        private static bool EditCloseVar(List<Register> list, int idx)
                        {
                            if (list.Count <= idx)
                                return false;
                            if (list[idx].Edited)
                ...
                #region Convert Parameters
                    ...
                    #region Convert Parameters Functions
                        ...
                        private static void AddFunctVarsAndConsts(List<Variable> list, List<Command> line,List<string> positions)
                        {
                            int i;
                            for(i=0;i<list.Count;i++)
                            {
                ...
                private static void FillWithPushPulls(List<Command> line)
                {
                    if (_regUsed == -1)
                    {
                ...
                private static void AddFunctName(List<Command> line, string name)
                {
                    var c = new Command();
                    c.Label = name;
                    c.Instruction = "";
                ...
                #region Const and Temp
                    ...
                    #region Const
                        ...
                        private static string CreateConst(string name, List<Variable> list, Variable var)
                        {
                            if (!(name[0].IsNumberPart()))
                                return name;
                            string s;
                    ...
                    #region Temp
                        ...
                        private static string CreateTemp(List<Variable> list, Variable var)
                        {
                            Variable v = var.Clone();
                            v.IsTemp = true;
                            v.Name = GetTempName();
        ...
        #region Add Global Variable Values
            ...
            private static void AddGlobalArray(Variable var, List<Command> line)
            {
            ...
            private static string AddAdditionalFunctions(string input)
            {
                ...
                try
                {
                    ...
                    {
                        var files = Directory.GetFiles(ProgramStats.DefaultAdditionalFunctionsFolder, additionalFunction + ".*");
                        if (files.Length <= 0)
                        {
                            continue;
                        }
        ...
        #region Additional Functions
            ...
            private static void RefreshValue(Variable var,List<Command> line)
            {
