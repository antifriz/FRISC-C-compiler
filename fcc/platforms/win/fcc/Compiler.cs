...
namespace fcc
{
    class Compiler
    {
        ...
        #region Print
            ...
            private static void Print(IEnumerable<Command> list)
            {
                Console.WriteLine();
            ...
            public static void PrintBlank(List<Command> list)
            {
            ...
            public static void PrintToStream(List<Command> list)
            {
            ...
            private static void Print(Command c)
            {
            ...
            private static void PrintBlank(Command c)
            {
            ...
            private static void PrintToStream(Command c,TextWriter stream)
            {
                if (c.Instruction == null)//|| c.Instruction.Contains(':') || c.Instruction.Contains(';'))
                    return;
            ...
            private static void Print(IEnumerable<Function> list)
            {
                Console.WriteLine();
            ...
            private static void Print(IEnumerable<Variable> list)
            {
                Console.WriteLine();
            ...
            private static void Print(IEnumerable<Register> list)
            {
                if (list == null)
                    return;
            ...
            private static void Print(Variable v)
            {
...
/*
        private static void InitializeParser()
        {
         ...
         // EmbeddedAllFunctionList.AddRange(Directory.GetFiles(ProgramStats.DefaultBuiltInFunctionsFolder, "*.a"));
        }*/
            ...
            #region Parsing Functions
                ...
                #region Parsing Commands
                    ...
                    private static void PreParsing(ICollection<Variable> list, string name)
                    {
                        ...
                        for (; ; i++)
                        {
                            ...
                            while ((idxS = buffer.IndexOf('\"', idxE + 1)) >= 0)
                            {
                                ...
                                v.IsGlobal=true;
								GlobalVariableDeclaredList.Add(v);
								list.Add (v);
                            }
                        }
                    ...
                    #region Parsing Commands Functions
                        ...
                        private static void ParseCommandDereferenced(Variable dest, string buffer, ICollection<Variable> list, ICollection<Command> line)
                        {
                        ...
                        private static void ParseCommandVariable(Variable dest, string buffer, ICollection<Variable> list, ICollection<Command> line)
                        {
                            #region Variables
                                        ...
                                        default:
                                            ...
                                            if (!op1.Contains('['))
                                            {
                                                ...
                                                else
                                                {
													...
													line.Add (new Command(){Instruction = "HEJ"});
                                                    c.Instruction = "STORE";
													...
													line.Add (new Command(){Instruction = "HEJNO"});
                                                }
                                            }
                                ...
                                case (5):
                                    ...
                                    switch (operand)
                                    {
                                        ...
                                        case ("<="):
                                            ...
                                            line.Add(c);
                                            c = new Command();
                                            c.Instruction = dest.Type.IsSigned() ? "DB 04, 00, 00, 0D7; JR_SLE (PC+4)" : "DB 04, 00, 40, 0D6; JR_ULE (PC+4)";
                                            c.Touch = false;
                                            line.Add(c);
                                            c = new Command();
                                            c.Instruction = "MOVE";
                                        ...
                                        case (">="):
                                            ...
                                            line.Add(c);
                                            c = new Command();
                                            c.Instruction = dest.Type.IsSigned() ? "DB 04, 00, 40, 0D7; JR_SGE (PC+4)" : "DB 04, 00, C0, 0D5; JR_UGE (PC+4)";
                                            c.Touch = false;
                                            line.Add(c);
                                            c = new Command();
                                            c.Instruction = "MOVE";
                                        ...
                                        case ("<"):
                                            ...
                                            line.Add(c);
                                            c = new Command();
                                            c.Instruction = dest.Type.IsSigned() ? "DB 04, 00, C0, 0D6; JR_SLT (PC+4)" : "DB 04, 00, C0, 0D4; JR_ULT (PC+4)";
                                            c.Touch = false;
                                            line.Add(c);
                                            c = new Command();
                                            c.Instruction = "MOVE";
                                        ...
                                        case (">"):
                                            ...
                                            line.Add(c);
                                            c = new Command();
                                            c.Instruction = dest.Type.IsSigned() ? "DB 04, 00, 80, 0D7; JR_SGT (PC+4)" : "DB 04, 00, 80, 0D6; JR_UGT (PC+4)";
                                            c.Touch = false;
                                            line.Add(c);
                                            c = new Command();
                                            c.Instruction = "MOVE";
                        ...
                        private static void ParseCommandFunction(string buffer, ICollection<Variable> list, ICollection<Command> line, string result)
                        {
                            Command c;
                            _started = true;
                ...
                #region Convert To Registers
                    ...
                    #region Convert To Registers Functions
                        ...
                        private static List<Command> AddLoad(List<Command> lines, Register reg, IEnumerable<Variable> list)
                        {
                            ...
                            c.MemReg = true;
                            lines.Insert(_currLine++, c);
                            if (MatchingLinesRefresh(lines[_currLine - 2], lines[_currLine]) && MatchingLinesRefresh(lines[_currLine - 1], lines[_currLine + 1]))
                            {
                ...
                #region Convert Parameters
                    ...
                    #region Convert Parameters Functions
                        ...
                        private static void AddFunctArray(Variable var, IList<Command> line,string position)
                        {
							...
							var klon = var.Clone ();
							klon.IsGlobal=true;
							klon.Name=GetConstName ();
							GlobalVariableDeclaredList.Add (klon);
                ...
                #region Const and Temp
                    ...
                    #region Const
                        ...
                        {
                            return "const." + _noConst++.ToString();
                        }
        ...
        #region Add Global Variable Values
            ...
            private static string AddAdditionalFunctions(string input)
            {
                ...
                try
                {
                    foreach (var builtInFunction in EmbeddedUsedFunctionList)
                    {
                        var files = Directory.GetFiles(AppData.BuiltInFunctionsPath, builtInFunction+".*");
                        if (files.Length <= 0)
                        {
                            File.Create(Path.Combine(AppData.BuiltInFunctionsPath, builtInFunction)+AppData.OutputExtension).Close();
                ...
                try
                {
                    ...
                    {
						var additionalFunction = AdditionalFunctionList.ElementAt (i);
                        var files = Directory.GetFiles(AppData.AdditionalFunctionsPath, additionalFunction + ".*",SearchOption.AllDirectories);
                        if (files.Length <= 0)
                        {
                            continue;
                        }
                        ...
                        {
                            Error.PrintError("File unreachable: " + Path.Combine(AppData.AdditionalFunctionsPath,AppData.OutputExtension));
                            return null;
                        }
                    }
                }
